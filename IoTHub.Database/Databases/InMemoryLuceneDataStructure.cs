...
namespace IoTHub.Database.InMemoryLuceneDataBase;

public class InMemoryLuceneDataBase
{
    private List<Cluster> clusters;

    public InMemoryLuceneDataBase(int numClusters, int numShardsPerCluster, int replicationFactor)
    {
